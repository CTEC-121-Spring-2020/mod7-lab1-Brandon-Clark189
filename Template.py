...
def main():
    ...
    print(myStr)
    print(myStr[6])
    # guarentees character is last.
    print(myStr[len(myStr)-1])
    print(myStr[10])
    print(myStr[0])
    # outputs going from end of string starting from d and going left
    print(myStr[-1])
    print(myStr[-5])
    ...
    print("3rd element of myList2: ", myList2[2])
